...
<div class="wrapper" style="height: 100vh; overflow-x: hidden;">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="index3.html" class="brand-link">
      <img src="{{ asset('img/polinema.png') }}" alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
      <span class="brand-text font-weight-light">Praktikum View</span>
    </a>
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
          <a href="#" class="d-block">Silva Tria Alfares</a>
        </div>
      </div>
  ...
  <footer class="main-footer d-flex justify-content-center">
    <!-- Default to the left -->
    <strong class="text-center">Copyright &copy; 2023 <a href="">Alfa</a>. </strong> All rights reserved.
  </footer>
</div>
<!-- ./wrapper -->
